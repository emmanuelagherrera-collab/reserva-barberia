...
def enviar_correo_confirmacion(datos):
    ...
    # 2. Generar Link de Modificación para el correo
    ...
    msg = MIMEMultipart()
    msg['From'] = f"Barbería Pro <{remitente}>"
    msg['To'] = destinatario
      ...
      <body style="font-family: Arial, sans-serif; color: #333;">
        <div style="max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
            ...
            <div style="background-color: #f1f1f1; padding: 10px; text-align: center; font-size: 12px; color: #777;">
                <p>Por favor llega 5 minutos antes. Si te retrasas más de 10 minutos, podríamos perder tu cupo.</p>
            </div>
        </div>
      </body>
    </html>
                ...
                if agendar_evento_confirmado(data, pid):
                    ...
                    with st.container(border=True):
                        ...
                        * 🏠 **Saldo Pendiente:** :red[**${data['pendiente']:,}**]
                        ...
                        ---
                        ℹ️ **Importante:** Hemos enviado un correo a **{data['email']}** con los detalles y el enlace para cambios.
                        """)
...
def panel_espera_pago():
    ...
    if pagado:
        ...
        if exito_calendar:
            ...
            # 📧 ENVIAR CORREO TAMBIÉN EN EL FLUJO AUTOMÁTICO
